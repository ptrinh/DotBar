...
- **Keywords** (no words from name/subtitle, max 100): anthropic,quota,limit,tokens,monitor,cpu,ram,battery,calendar,developer,xbar,swiftbar,textbar
...
- **Description**:
  ...
  • You allow access once; your sign-in never leaves your Mac, and DotBar sends it only to the AI provider to read your usage.
  ...
  Claude is a trademark of Anthropic, and Codex a trademark of its owner. DotBar is not affiliated with either.
